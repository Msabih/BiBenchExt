...
model = dict(
    ...
    arch=dict(
        ...
        backbone=dict(
            ...
            dilation=1,
            drop_path_rate=0.0,
            conv2d_cfg=dict(type='CBNNConv2d', k_bits=10),
            conv1d_cfg=dict(type='CBNNConv1d', k_bits=10),
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='data/Pretrained/Google speech commands/epoch_200.pth'))
)
...
resume_from = None
workflow = [('train', 1)]
work_dir = 'D:\study\S3\Project thesis\Results\Speech detection\dfsmn_cbnn\8_10'
gpu_ids = range(0, 1)
